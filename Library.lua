...
b = {
	[1] = function()
		...
		function x.dialog(p, t, d, call, theme)
			...
			local hf = f("Frame", {
				...
				f("CanvasGroup", {
					BorderSizePixel = 0,
					BackgroundColor3 = a.Theme[theme.Theme or 'Quertzy']['Diglog Background'],
					...
					f("Frame", {
						BorderSizePixel = 0,
						BackgroundColor3 = a.Theme[theme.Theme or 'Quertzy']['Diglog Top Bar'],
						...
						f("TextLabel", {
							...
							TextColor3 = a.Theme[theme.Theme or 'Quertzy']['Text Color'],
							BackgroundTransparency = 1,
							RichText = true,
							AnchorPoint = Vector2.new(0.5, 0.5),
		...
		function x.background(parent, text, desc, ghfd, theme)
			...
			local hg = f("Frame", {
				Parent = parent,
				BorderSizePixel = 0,
				BackgroundColor3 = a.Theme[theme.Theme or 'Quertzy']['Background Function'],
				Size = UDim2.new(1, 0, 0, 200),
				BorderColor3 = Color3.fromRGB(0, 0, 0),
				BackgroundTransparency = a.Theme[theme.Theme or 'Quertzy']['Background Function Transparency'],
	...
	CreateWindow = function(self, op)
		...
		local fo = f("CanvasGroup", {
			...
			f("Frame", {
				BorderSizePixel = 0,
				BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Top Bar'],
				Size = UDim2.new(1, 0, 0, 50),
				BorderColor3 = Color3.fromRGB(0, 0, 0)
			}, {
				f("UIPadding",{
				...
				f("Frame", {
					...
					f("Frame", {
						BorderSizePixel = 0,
						BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Tab Bar'],
						Size = UDim2.new(1, 0, 0, 25),
						BorderColor3 = Color3.fromRGB(0, 0, 0),
					}, {
		...
		function g:CreateTab(gfjd)
			...
			local Tab = f("Frame", {
				...
				f("UIGradient", {
					Color = ColorSequence.new{ColorSequenceKeypoint.new(0.000, a.Theme[op.Theme or 'Quertzy']['Color Tab'][1]),ColorSequenceKeypoint.new(1.000, a.Theme[op.Theme or 'Quertzy']['Color Tab'][2])}
				}),
				f("TextLabel", {
					TextWrapped = true,
					BorderSizePixel = 0,
			...
			local Page = f("Frame", {
				...
				f("CanvasGroup", {
					BorderSizePixel = 0,
					BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Background Page'],
					Size = UDim2.new(1, 0, 1, 0),
					BorderColor3 = Color3.fromRGB(0, 0, 0)
				}, {
					...
					f("Frame", {
						BorderSizePixel = 0,
						BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Top Bar Page'],
						...
						f("Frame", {
							...
							f("Frame", {
								BorderSizePixel = 0,
								BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Search'],
								AnchorPoint = Vector2.new(1, 0.5),
								Size = UDim2.new(1, 0, 0, 20),
								Position = UDim2.new(1, 0, 0.5, 0),
								BorderColor3 = Color3.fromRGB(0, 0, 0)
					...
					f("Frame", {
						...
						f("ScrollingFrame", {
							...
							ScrollBarImageColor3 = a.Theme[op.Theme or 'Quertzy']['Color Main'],
							Position = UDim2.new(0.5, 0, 1, 0),
							BorderColor3 = Color3.fromRGB(0, 0, 0),
			...
			local function selectt()
				...
				b[1]().tw({
					...
					s = "Linear",
					d = "Out",
					g = {TextColor3 = a.Theme[op.Theme or 'Quertzy']['Text Tab Select']}
				}):Play()
				delay(.3,function()
					Page.Visible = true
					b[1]().tw({
				...
				for i,v in pairs(patab:GetChildren()) do
					if v:IsA("Frame") then
						...
						b[1]().tw({
							...
							s = "Linear",
							d = "Out",
							g = {TextColor3 = a.Theme[op.Theme or 'Quertzy']['Text Color']}
						}):Play()
					end
				end
			...
			function Func:CreateToggle(khgkgh)
				...
				local toggle = f("Frame", {
					...
					f("Frame", {
						BorderSizePixel = 0,
						BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Toggle Color'],
			...
			function Func:CreateDropdown(khgkgh)
				...
				local dropdown = f("Frame", {
					...
					f("Frame", {
						AnchorPoint = Vector2.new(1, 0.5),
						BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Dropdown Color'],
						BorderColor3 = Color3.fromRGB(0,0,0),
						BorderSizePixel = 0,
						Size = UDim2.new(1, 0,0, 20),
						Position = UDim2.new(1, 0, 0.5, 0)
				...
				local dropdownselect = f("Frame", {
					Parent = fo.Parent,
					BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Dropdown Select Background'],
					BorderColor3 = Color3.fromRGB(0,0,0),
					BorderSizePixel = 0,
					...
					f("UIStroke", {Color = a.Theme[op.Theme or 'Quertzy']['Dropdown Select Stroke'], Transparency = 1}),
					f("ScrollingFrame", {
						Active = true,
						BackgroundColor3 = Color3.fromRGB(255,255,255),
						BackgroundTransparency = 1,
				...
				function itemslist:Add(t)
					local item = f("Frame", {
						...
						BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Dropdown Item'],
...
function Func:CreateSlider(khgkgh)
	...
	return NewSet
		...
		local CloseUI = f("ImageButton", {
			...
			AnchorPoint = Vector2.new(0.5, 0.5),
			BackgroundColor3 = a.Theme[op.Theme or 'Quertzy']['Background'],
			BackgroundTransparency = a.Theme[op.Theme or 'Quertzy']['Background Transparency'],
			BorderColor3 = Color3.fromRGB(0,0,0),
			BorderSizePixel = 0,
